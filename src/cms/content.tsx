...
export const LIONS_CMS: SiteConfig = {
    ...
    hero: {
        videoUrl: 'https://www.youtube.com/embed/L-5aa-5xqOI?autoplay=1&mute=1&controls=0&loop=1&playlist=L-5aa-5xqOI&rel=0&showinfo=0&iv_load_policy=3&modestbranding=1&disablekb=1',
        title: 'SAMSUNG LIONS',
    ...
    goods: {
        sectionTitle: 'LIONS GOODS SHOP',
        items: [
            { id: 'g1', name: 'Home Uniform 2024', price: '120,000₩', badge: 'NEW' },
            { id: 'g2', name: 'Winning Cap', price: '35,000₩', badge: 'BEST' },
            { id: 'g3', name: 'Lion Mascot Doll', price: '28,000₩' },
        ],
    },
    socialAdGrid: [
        { type: 'SNS', title: 'INSTAGRAM', content: '@samsunglions_notes', color: '#E1306C', link: 'https://instagram.com' },
        { type: 'AD', title: 'TICKET', content: '지금 당장 라이온즈 파크로!', color: '#074CA1', link: '#' },
        { type: 'SNS', title: 'YOUTUBE', content: 'Lions TV 구독하기', color: '#FF0000', link: 'https://youtube.com' },
        { type: 'AD', title: 'MEMBER', content: '라이온즈 몰 포인트 2배 적립', color: '#00357A', link: '#' },
    ],
    socialLogos: [
